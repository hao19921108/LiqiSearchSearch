...
let secretCode=['活着就是来搜搜看',"不晓得你就搜搜看","输入关键词搜索","活着的意义？？","这个人到底在干嘛？怎么那么不听话","输入关键词马上发问?","活着就是来问问题的"]
let blinkDivide =3;
...
var messages=['明天股票涨嘛？','为什么没钱？','活着的意义？','可不可以不上班？','怎么脱单？',"爱情为什么这么累？","世界上有外星人吗？","地球为什么是圆的？","阶级什么时候消失？","我们是真实存在的吗？","死后会去哪？","我是谁？我从哪里来？我将去哪里？",'Apple','Banana','Spinach','Cucumber','Meat','Pork','Steak','Burger','Mushroom','Corn','Beef','Tomato','Potato','Milk','Peas','Broccoli','City lockdown','Get rich','Shanghainese is occupying...','Life','Regular life',"Rolex","Ferrari","Cartier","Dior","Baidu","Tiktok","Risotto Restaurant","Please typing...","Sykiyaki Maker","Covid","Search",'Tsunami Lover','Balenciaga','Okinawa Hater','Air Jordan 4 Collector','Apple',"Banana's republic","McLaren","Estee Lauder","Fendi","Gucci","Hermes","IKEA","Bentley","Kia","Ford","Loro Piana","Microsoft Top Secret","Nike","SK-II","Lululemon","Opensea","Porsche","Prada","Rolex","Omega","SSENSE","GOAT","Tiffany&Co","Moncler","Acne Studio",'LOEWE','Valentino',"Y3","Yeezy","Food","Omega","Bulgari","COACH","Lancome","CHANEL","Hao","Givenchy","HONDA","Bottega Veneta","BMW",'Supreme',"Mercedes","Victoria's Secret","Armani","Van Cleef & Arpels",'Dolce & Gabbana',"Yves Saint Laurent",'Lamborghini','Yeezy','LV','Salvatore Ferragamo','Maserati','Burberry','Rolls Royce'];
